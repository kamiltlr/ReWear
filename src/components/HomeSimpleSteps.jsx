        ...
        <div id='about' className='about'>
            ...
            <div className='about-columns'>
                <div className="about-column">
                    <img src="./src/assets/Icon-1.svg" alt="icon" />
                    <p>Wybierz rzeczy</p>
                    <span>────────</span>
                ...
                <div className="about-column">
                    <img src="./src/assets/Icon-2.svg" alt="icon" />
                    <p>Spakuj je</p>
                    <span>────────</span>
                ...
                <div className="about-column">
                    <img src="./src/assets/Icon-3.svg" alt="icon" />
                ...
                <div className="about-column">
                    <img src="./src/assets/Icon-4.svg" alt="icon" />
                    <p>Zamów kuriera</p>
                    <span>────────</span>
